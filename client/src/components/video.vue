  ...
  <div ref="component" class="video">
    <div ref="player" class="player">
      <div ref="container" class="player-container">
        ...
        <div class="emotes">
          <template v-for="(emote, index) in emotes" :key="index">
            <neko-emote :id="index" />
          </template>
        </div>
        <textarea
...
<script lang="ts">
  ...
  export default defineComponent({
    ...
    props: {
      ...
      extraControls: { type: Boolean },
    },
    data() {
      return {
        keyboard: GuacamoleKeyboard(),
    ...
    computed: {
      ...
      _overlay() {
        return this.$refs.overlay as HTMLTextAreaElement
      },
      _aspect() {
        return this.$refs.aspect as HTMLElement
      },
      _player() {
      ...
      _resolution() {
        return this.$refs.resolution as any
      },
      _clipboard() {
        return this.$refs.clipboard as any
      },
      admin() {
    ...
    watch: {
      ...
      muted: 'onMutedChanged',
      stream: 'onStreamChanged',
      playing: 'onPlayingChanged',
